        ...
        <div className={`inventory-modal ${inventoryHidden ? "inventory-hidden" : ""}`}>
            ...
            <div className="inventory-body">
                ...
                <div className="inv-power-container">    
                    ...
                    <div className="inv-qty">{luckyLevel > 0 ? `${(luckyLevel * 5) + (Math.floor(level/20) * luckyLevel * 2)} coins` : ""}</div>
                </div>
                <div className="inv-power-container">    
                    ...
                    <div className="inv-qty">{unluckyLevel > 0 ? `${(unluckyLevel * 2) + (Math.floor(level/20) * unluckyLevel)} coins` : ""}</div>
                </div>
            </div>
