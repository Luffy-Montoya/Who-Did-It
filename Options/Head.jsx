            ...
            <div className="options-display">
                <div className="options-scroll" ref={scrollRef}>
                    <div className="options-list">
                        ...
                        <button onClick={() => setQuestion([head.any, "head", "none"])}><div>Any</div><div className="price">{cost(7)}</div></button>
                        <button onClick={() => setQuestion([head.glasses, "head", "glasses"])}><div>Glasses</div><div className="price">{cost(7)}</div></button>
                        <button onClick={() => setQuestion([head.hat, "head", "hat"])}><div>Hat</div><div className="price">{cost(7)}</div></button>
                        <button onClick={() => setQuestion([head.bowBand, "head", "bow/headband"])}><div>Bow / Band</div><div className="price">{cost(7)}</div></button>
                        <div class="ghost-div"></div>                                    
                    </div>
                </div>
            </div>
